...
order_status = Enum('pending', 'paid', 'cancelled', 'shipped', 'delivered', 'expired', name='order_status')
...
class Order(Base):
    ...
    tracking_code: Mapped[str] = mapped_column(String(64), default='')
    tracking_events: Mapped[list] = mapped_column(JSON, default=list)
